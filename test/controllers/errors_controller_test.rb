...
class ErrorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create error" do
    assert_difference('Error.count') do
      post errors_url, params: { error: { internal_server_error: @error.internal_server_error, not_found: @error.not_found } }
    end
  ...
  test "should update error" do
    patch error_url(@error), params: { error: { internal_server_error: @error.internal_server_error, not_found: @error.not_found } }
